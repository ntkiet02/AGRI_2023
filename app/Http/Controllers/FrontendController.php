...
class FrontendController extends Controller
{
    ...
    function index(Request $request, $locale = '') {
        $danhsach = TinTucSuKien::where('locale', '=', $locale)->orderBy('date_post', 'desc')->paginate(9);
        return view('Frontend.index')->with(compact('danhsach'));
    }
    ...
    function tin_tuc_su_kien(Request $request, $locale = '') {
        $danhsach = TinTucSuKien::where('locale', '=', $locale)->orderBy('date_post', 'desc')->paginate(7);
